...
A01 =[
	 cos(q1 - 2.01), 0,      sin(q1 - 2.01), 33*cos(q1 - 2.01);
	 sin(q1 - 2.01), 0, -cos(q1 - 2.01), 33*sin(q1 - 2.01);
	             0,                   1,           0,              147;
	             0,                     0,           0,                1];
A12=[
		 cos(q2 - 0.36), 		-sin(q2 - 0.36),   0, 155*cos(q2 - 0.36);
		 sin(q2 - 0.36),      cos(q2 - 0.36),   0, 155*sin(q2 - 0.36);
		              0,                   0, 1.0,                    0;
		              0,                   0,   0,                  1];
	
A23=[
	 cos(q3 + 1.2), -sin(q3 + 1.2),   0, 135*cos(q3 + 1.2);
	 sin(q3 + 1.2),      cos(q3 + 1.2),   0, 135*sin(q3 + 1.2);
	             0,                  0, 1.0,                   0;
	             0,                  0,   0,                 1];
